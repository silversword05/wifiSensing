...
pd_signal_mat = load('data/data_1/pd_signal1.mat', 'pd_signal');
...
plot(br_estimates);
saveas(gcf,'data/data_1/br_estimates_plomb.fig');
save('data/data_1/br_estimates_plomb.mat',"br_estimates");
save('data/data_1/br_estimates_plomb_all.mat',"br_estimates_all");
save('data/data_1/timestamps_plomb.mat',"timestamps");
